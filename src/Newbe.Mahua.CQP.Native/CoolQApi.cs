...
namespace Newbe.Mahua.CQP.Native
{
    public class CoolQApi : ICoolQApi
    {
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_sendPrivateMsg([Description("")] int AuthCode, [Description("目标帐号")] long Account,
        ...
        /// <param name="msg">消息内容</param>
        /// <returns></returns>
        int ICoolQApi.CQ_sendGroupMsg([Description("")] int AuthCode, [Description("目标群")] long 群号,
            [Description("消息内容")] string msg)
        ...
        /// <param name="msg">消息内容</param>
        /// <returns></returns>
        int ICoolQApi.CQ_sendDiscussMsg([Description("")] int AuthCode, [Description("目标讨论组")] long 讨论组号,
            [Description("消息内容")] string msg)
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_deleteMsg([Description("")] int AuthCode, [Description("消息ID")] long MsgId)
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_sendLikeV2([Description("")] int AuthCode, [Description("目标帐号")] long Account,
        ...
        /// <returns></returns>
        string ICoolQApi.CQ_getCookiesV2([Description("")] int AuthCode, [Description("目标域名，如 api.example.com")]
            string domain)
        ...
        /// <returns></returns>
        string ICoolQApi.CQ_getRecord([Description("")] int AuthCode, [Description("收到消息中的语音文件名(file)")] string file,
        ...
        /// <param name="outformat">应用所需的格式</param>
        /// <returns></returns>
        string ICoolQApi.CQ_getRecordV2([Description("")] int AuthCode, [Description("收到消息中的语音文件名(file)")] string file,
            [Description("应用所需的格式")] string outformat)
        ...
        /// <returns></returns>
        string ICoolQApi.CQ_getImage([Description("")] int AuthCode, [Description("收到消息中的图片文件名(file)")] string file)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        int ICoolQApi.CQ_canSendImage([Description("")] int AuthCode)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        int ICoolQApi.CQ_canSendRecord([Description("")] int AuthCode)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        int ICoolQApi.CQ_getCsrfToken([Description("")] int AuthCode)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        string ICoolQApi.CQ_getAppDirectory([Description("")] int AuthCode)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        long ICoolQApi.CQ_getLoginQQ([Description("")] int AuthCode)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        string ICoolQApi.CQ_getLoginNick([Description("")] int AuthCode)
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupKick([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupBan([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupAdmin([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupSpecialTitle([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupWholeBan([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupAnonymousBan([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupAnonymous([Description("")] int AuthCode, [Description("")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupCard([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupLeave([Description("")] int AuthCode, [Description("目标群")] long 群号,
        ...
        /// <param name="讨论组号">目标讨论组</param>
        /// <returns></returns>
        int ICoolQApi.CQ_setDiscussLeave([Description("")] int AuthCode, [Description("目标讨论组")] long 讨论组号)
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setFriendAddRequest([Description("")] int AuthCode,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setGroupAddRequestV2([Description("")] int AuthCode,
        ...
        /// <param name="内容"></param>
        /// <returns></returns>
        int ICoolQApi.CQ_addLog([Description("")] int AuthCode, [Description("#Log_ 开头常量")] int 优先级,
        ...
        /// <returns></returns>
        int ICoolQApi.CQ_setFatal([Description("")] int AuthCode, [Description("")] string 错误信息)
        ...
        /// <returns></returns>
        string ICoolQApi.CQ_getGroupMemberInfoV2([Description("")] int AuthCode, [Description("目标帐号所在群")] long 群号,
        ...
        /// <param name="群号">目标帐号所在群</param>
        /// <returns></returns>
        string ICoolQApi.CQ_getGroupMemberList([Description("")] int AuthCode, [Description("目标帐号所在群")] long 群号)
        ...
        /// <param name="AuthCode"></param>
        /// <returns></returns>
        string ICoolQApi.CQ_getGroupList([Description("")] int AuthCode)
        ...
        /// <returns></returns>
        string ICoolQApi.CQ_getFriendList([Description("")] int AuthCode, [Description("保留参数，请传入“假”")] bool reserved)
        ...
        /// <param name="不使用缓存"></param>
        /// <returns></returns>
        string ICoolQApi.CQ_getStrangerInfo([Description("")] int AuthCode, [Description("目标帐号")] long Account,
        ...
        /// <param name="不使用缓存"></param>
        /// <returns></returns>
        string ICoolQApi.CQ_getGroupInfo([Description("")] int AuthCode, [Description("目标群")] long 群号,
            [Description("")] bool 不使用缓存)
        ...
        /// <returns></returns>
        bool ICoolQApi.CryptStringToBinaryA([Description("址")] string pszString, [Description("址")] int cchString,
